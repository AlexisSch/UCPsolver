...
echo 'N, T, cost_linear, time_linear, cost_column2, time_column2, number_column2,  cost_column3, time_column3, number_column3' >> exit_data.csv
echo >> exit_data.csv
cd ..
...
do
    ...
    ./ucp.exe   ../data/32-72/instance_$i.txt   ../exit/exit_data.csv   1000   0
done
