...
SCIP_RETCODE FormulationPricer::create_constraints()
{
...
std::vector< std::vector< SCIP_VAR* >> FormulationPricer::get_variable_u()
{
    return( m_variable_u );
}


std::vector< std::vector< SCIP_VAR* >> FormulationPricer::get_variable_x()
{
    return( m_variable_x );
}


std::vector< std::vector< SCIP_VAR* >> FormulationPricer::get_variable_p()
{
    return( m_variable_p );
}
