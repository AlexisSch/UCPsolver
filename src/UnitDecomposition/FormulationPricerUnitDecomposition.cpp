...
SCIP_RETCODE FormulationPricerUnitDecomposition::create_variables(vector<SCIP_Real> reduced_costs_demand)
{
    ...
    int unit_number = m_instance->get_units_number();
    int time_step_number = m_instance->get_time_steps_number();
    ...
    for(int i_unit = 0; i_unit < unit_number; i_unit ++)
    {
        ...
        for(int i_time_step = 0; i_time_step < time_step_number; i_time_step ++)
        {
            ...
            int fixed_cost_unit_i(m_instance->get_costs_fixed()[i_unit]);
    ...
    for(int i_unit = 0; i_unit < unit_number; i_unit ++)
    {
        ...
        int cost_start_i(m_instance->get_costs_startup()[i_unit]);
    ...
    vector<int> prod_max( m_instance->get_production_max() );
    vector<int> cost_prop( m_instance->get_costs_proportionnal() );
    for(int i_unit = 0; i_unit < unit_number; i_unit ++)
    {
...
SCIP_RETCODE FormulationPricerUnitDecomposition::create_constraints()
{
    ...
    vector<int> initial_state(m_instance->get_initial_state());
    for(int i_unit = 0; i_unit < unit_number; i_unit++)
    {
    ...
    for(int i_unit = 0; i_unit < unit_number; i_unit ++)
    {
        ...
        for(int i_time_step = 0; i_time_step < time_step_number; i_time_step ++)
        {
            ...
            // add the variables
            int prod_max_i( m_instance->get_production_max()[i_unit]);
    ...
    for(int i_unit = 0; i_unit < unit_number; i_unit ++)
    {
        ...
        for(int i_time_step = 0; i_time_step < time_step_number; i_time_step ++)
        {
            ...
            // add the variables
            int prod_min_i( m_instance->get_production_min()[i_unit] );
    ...
    vector<int> min_uptime = m_instance->get_min_uptime();
    for(int i_unit = 0; i_unit < unit_number; i_unit ++)
    {
    ...
    vector<int> min_downtime = m_instance->get_min_downtime();
    for(int i_unit = 0; i_unit < unit_number; i_unit ++)
    {
...
// * gets 
std::vector< std::vector< SCIP_VAR* >> FormulationPricerUnitDecomposition::get_variable_u()
{
    return( m_variable_u );
}


std::vector< std::vector< SCIP_VAR* >> FormulationPricerUnitDecomposition::get_variable_x()
{
    return( m_variable_x );
}


std::vector< std::vector< SCIP_VAR* >> FormulationPricerUnitDecomposition::get_variable_p()
{
    return( m_variable_p );
}
