...
SCIP_RETCODE FormulationPricerUnitDecomposition2::create_variables(vector<SCIP_Real> reduced_costs_demand)
{
    ...
    for(int i_time_step = 0; i_time_step < number_of_time_steps; i_time_step ++)
    {
        ...
        SCIP_CALL( SCIPcreateVarBasic( m_scip_pricer,
            ...
            cost_prop[m_unit_number] - reduced_costs_demand[i_time_step],              // coeff in obj function
